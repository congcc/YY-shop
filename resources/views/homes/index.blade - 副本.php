									...
									<div class="category" style="height: 330px;">
										...
										<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/homes/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">{{$v->cate_name}}</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																@foreach($resb[$k] as $o=>$p)
																	<dl class="dl-sort">
																	
																	
																		<dt><span title="饼干">{{$p->cate_name}}</span></dt>
																		@foreach($p->catetwo as $q=>$w)
																		<dd><a title="蒸蛋糕" href="#"><span>{{$w->cate_name}}</span></a></dd>
