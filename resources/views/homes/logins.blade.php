      ...
      <div class="am-tabs" id="doc-my-tabs">
        ...
        <div class="am-tab-panel">
          <form >
            ...
            <div id="e4" style="width: 200px;height: 20px;color: red;font-size: 13px;font-weight: bold;display: none;"></div>
            <div class="user-pass">
              <label for="password">
          ...
          <div class="am-cf">
            <input type="submit" name="" id="regi" value="修改密码" disabled="true" class="am-btn am-btn-primary am-btn-sm am-fl"></div>
          <hr></div>
          </form>
        <script>$(function() {
            $('#doc-my-tabs').tabs();
  ...
  $('#regi').click(function(){
    //修改密码
        ...
        if(ch1==100&&ch2==100&&ch3==100&&ch4==100){
            ...
            console.log(ph);
	        $.post('/home/login',{'_token':'{{ csrf_token() }}',password:password,phone:ph},function(data){
	        	console.log(data);
	            if (data) {
	                layer.open({
		          	   type: 1
