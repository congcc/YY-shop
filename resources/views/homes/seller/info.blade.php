...
<div class="user-info">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								...
								<img alt="" src="/homes/images/getAvatar.do.jpg" class="am-circle am-img-thumbnail">
							</div>
							...
							<form class="am-form am-form-horizontal">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" placeholder="nickname" id="user-name2">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" placeholder="name" id="user-name2">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content sex">
										<label class="am-radio-inline">
											<input type="radio" data-am-ucheck="" value="male" name="radio10" class="am-ucheck-radio"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span> 男
										</label>
										<label class="am-radio-inline">
											<input type="radio" data-am-ucheck="" value="female" name="radio10" class="am-ucheck-radio"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span> 女
										</label>
										<label class="am-radio-inline">
											<input type="radio" data-am-ucheck="" value="secret" name="radio10" class="am-ucheck-radio"><span class="am-ucheck-icons"><i class="am-icon-unchecked"></i><i class="am-icon-checked"></i></span> 保密
										</label>
									</div>
								</div>
								...
								<div class="am-form-group">
									<label class="am-form-label" for="user-phone">电话</label>
									<div class="am-form-content">
										<input type="tel" placeholder="telephonenumber" id="user-phone">
								...
								<div class="am-form-group address">
									<label class="am-form-label" for="user-address">收货地址</label>
								...
								<div class="am-form-group safety">
									<label class="am-form-label" for="user-safety">账号安全</label>
