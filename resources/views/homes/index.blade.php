										...
										@foreach($resa as $k=>$v)
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/homes/images/cake.png"></i><a class="ml-22" title="点心">{{$v->cate_name}}</a></h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																...
																<div class="sort-side">
														@foreach($v->two(substr($v->pid,0,1)) as $o=>$p)
																	@if($p->pid%100000!=0)
																	<dl class="dl-sort" style="height: 75px;">
