            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                ...
                aria-describedby="DataTables_Table_0_info">
                    ...
                    <tr class="">
                        ...
                        <td class=" ">
                            <a href="/admin/buyss/" onclick="return confirm('您确定要修改吗?')">
                                <button id="auth">
                                {{$v->ostate}}
                                </button>
                            </a>
                        ...
                        <td class=" ">
                            <span class="btn-group">
                                <a href="/admin/buys/" class="btn btn-small"><i>详情</i></a>
                                <a href="/admin/buys//edit" class="btn btn-small"><i>修改</i></a>
                               <form action="/admin/buys/" onclick="return confirm('您确定要删除吗?')" style='display:inline' method="post">
                                    {{csrf_field()}}
                                    {{method_field('DELETE')}}
