    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="/admin/user"><i class="icol32-widescreen"></i> 管理人员</a>
                        <ul class="closed">
                    ...
                    <li>
                        <a href=""><i class="icol32-vcard"></i> 身份认证</a>
                        <ul class="closed">
                            <li><a href="/admin/ident">待认证</a></li>
                            <li><a href="/admin/isucc">认证成功</a></li>
                            <li><a href="/admin/ifail">认证失败</a></li>
                        </ul>
                    </li>
                    <li>
