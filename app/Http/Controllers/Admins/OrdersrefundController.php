...
class OrdersrefundController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admins.orders.refund.index',compact('req','res','request'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admins.orders.refund.show',compact('orde','ordes','user','shop','good'));
    }
