...
class OrdersreturnController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $req = orders::where('ostate', '7')->get();

        return view('admins.orders.return.index',compact('req','res','request'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admins.orders.return.show',compact('orde','ordes','user','shop','good'));
    }
