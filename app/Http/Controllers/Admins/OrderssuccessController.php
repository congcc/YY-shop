...
class OrderssuccessController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $req = orders::where('ostate', '9')->get();

        return view('admins.orders.success.index',compact('req','res','request'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admins.orders.success.show',compact('orde','ordes','user','shop','good'));
    }
